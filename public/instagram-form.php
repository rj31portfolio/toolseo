...
<div class="section-head"><span class="eyebrow">PUBLIC POSTS &amp; REELS &middot; NO SIGN-UP</span><h2 id="instagram-heading"><?=e($instagramService['name'])?></h2><p><?=e($instagramService['description'])?></p></div>
...
<link rel="stylesheet" href="<?=url('/assets/css/instagram-downloader.css')?>"><script src="<?=url('/assets/js/instagram-downloader.js')?>" defer></script>
<?php endif;?>
