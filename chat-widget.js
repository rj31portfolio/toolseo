(() => {
 ...
 function boot(data){
  ...
  panel.append(heading,log,leadForm,status,tools,form);if(c.branding)panel.append(el('div','Powered by SEO Zentro','branding'));shadow.append(panel,launcher);
